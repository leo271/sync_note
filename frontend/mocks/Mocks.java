...
public class Mocks {
  public static final Head[] heads = {
      new Head("情理実験ソフトウェア制作")
          .addDocIDs(new String[] { "asduf9a8weurq23807yn", "a09n7s8efypaciwuasdjfn-cw", "uha0oseidnfpi as" }),
      new Head("代数学基礎A 5/14")
          .addDocIDs(new String[] { "a98nsenr-qpwcrdnoq3", "auw-n4rcqpmwilrhuoaw", "9-aw74jmecr9pawlehcfanp" }),
      new Head("プログラミングB 5/21").addDocIDs(new String[] { "ua-nwenfncdhsp98t7nq4", "a@w[e,f@c/a.lwioj[ern90av]]" }),
      new Head("情理実験検索エンジン評価").addDocIDs(new String[] { "a[w.es-0:9rviqwa4erv]" }),
      new Head("代数学基礎A 5/21").addDocIDs(new String[] { "ap9wernuic[ma]wpeirhpbv", "[imz-s0erao]w@:mpeoimr@" }),
      new Head("プログラミングB 5/28"),
      new Head("情理実験センサと制御"),
      new Head("情報通信ネットワーク 5/15"),
      new Head("トラヒック理論 5/16"),
      new Head("情理実験ハードウェア記述言語"),
      new Head("情報通信ネットワーク 5/15"),
  ...
  public static final HeadGroup[] headGroups = {
      ...
      new HeadGroup("早稲田大学情報理工学科").addHeadGroups(new String[] { "情理実験", "代数学基礎A", "プログラミングB", "情報通信ネットワーク" }),
  };
