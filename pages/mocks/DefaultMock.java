...
public class DefaultMock {
  public static final Head[] heads = {
      ...
      new Head("代数学基礎A 5/14").addDocIDs(new String[] {"asdpfpa894rmo;awce", "a:peowirnc@q20ur0q2"}),
      ...
      new Head("プログラミングB 5/28"), new Head("情理実験センサと制御"), new Head("情報通信ネットワーク"),
  ...
  public static final HeadGroup[] headGroups = {
      new HeadGroup("情理実験").addHeads(new Head[] {heads[0], heads[2], heads[5], heads[7], heads[9]}),
      new HeadGroup("代数学基礎A").addHeads(new Head[] {heads[1], heads[4]}),
      new HeadGroup("プログラミングB").addHeads(new Head[] {heads[6], heads[10]}),
      new HeadGroup("情報通信ネットワーク").addHeads(new Head[] {heads[8], heads[11]}),
